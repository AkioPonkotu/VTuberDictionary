...
from ..domain.filtering import ExistingEntryFilter, KatakanaOrLatinNameFilter, ThresholdFilter
...
class _CandidateSaver:
    """The sole caller of ``CandidateStore.replace`` while processing."""

    def __init__(
        self,
        repository: CandidateStore,
        reviews: ReviewStore,
