...
from ..application.discovery import AgencyDiscovery, TwitchDiscovery
from ..application.ports import ReadingResearcher, Verifier
from ..application.workflow import Pipeline
from ..domain.validation import DeterministicValidator
...
from ..infrastructure.dictionary import DictionaryCompiler
...
from ..infrastructure.web_sources import TwitchSearchSourcePrefetcher
...
async def discover(settings: Settings, discovery_sources: set[str] | None = None) -> None:
    ...
    from ..infrastructure.agency_source import AgencyPageTalentSource
